...
class AppointmentView(View):
    ...
    # 1 вариант. Отправляем письмо с помощью send_mail
        ...
        #     recipient_list=['roguesinister@yandex.ru'] # здесь список получателей. Например, секретарь, сам врач и так далее
        # )
    ...
    #  2 вариант. Отправляем на почту красивенько свёрстанный HTML-шаблон самой компании.
        ...
        #     to=['roguesinister@yandex.ru'], # это то же, что и recipients_list
        # )
